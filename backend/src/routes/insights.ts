...
import { insightsRefreshRateLimit } from '../middleware/aiRateLimit.js';
...
router.post('/api/insights/refresh', requireAuth, requirePro, insightsRefreshRateLimit, insightsController.refreshInsightsController);

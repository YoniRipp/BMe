...
vi.mock('@/core/api/subscription', () => ({
  subscriptionApi: {
    createCheckout: vi.fn().mockResolvedValue({ url: 'https://checkout.lemonsqueezy.com/mock' }),
    createPortal: vi.fn().mockResolvedValue({ url: 'https://portal.lemonsqueezy.com/mock' }),
  },
}));

...
export function TransactionList({ transactions, onEdit, onDelete, onAdd }: TransactionListProps) {
  return (
    <div className="space-y-2">
      {transactions.length === 0 ? (
        ...
        >
          <Plus className="w-12 h-12 mx-auto mb-3 text-muted-foreground" aria-hidden="true" />
        ...
        <>
          ...
          >
            <Plus className="w-8 h-8 mx-auto text-primary" aria-hidden="true" />
